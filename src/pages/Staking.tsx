                    ...
                    <div className="w-full md:w-[30%] lg:pl-10 pt-16 pb-5">
                        <div className="flex justify-between">
                            ...
                            <BlinkingUnderscoreInput
                                ...
                                handleInputChange={(e) => handleInputChange(e, setInputValue2)}
                                validatePrime={() => validatePrime(inputValue2, setInputValue2)}
                            />
                        </div>
                        <div className="flex w-full justify-between">
                    ...
                    <div className="w-full md:w-[30%] lg:pl-10 pt-16 pb-5">
                        <div className="flex justify-between">
                            ...
                            <BlinkingUnderscoreInput
                                ...
                                handleInputChange={(e) => handleInputChange(e, setInputValue3)}
                                validatePrime={() => validatePrime(inputValue3, setInputValue3)}
                            />
                        </div>
                        <div className="flex w-full justify-between">
